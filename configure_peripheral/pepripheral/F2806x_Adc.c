...
void InitAdc(void)
{
    ...
    AdcRegs.ADCSOC1CTL.bit.CHSEL= 9;
    AdcRegs.ADCSOC2CTL.bit.CHSEL= 2;
    AdcRegs.ADCSOC3CTL.bit.CHSEL= 10;
    // SOC0 kich bang timer 0 va SOC2 kich bang software
    AdcRegs.ADCSOC0CTL.bit.TRIGSEL = 1; 
    AdcRegs.ADCSOC2CTL.bit.TRIGSEL = 0;
    // adc sample mode = simultaneous mode
    AdcRegs.ADCSAMPLEMODE.bit.SIMULEN0 = 1;
    AdcRegs.ADCSAMPLEMODE.bit.SIMULEN2 = 1;

    // Enabled interrupt ADCINT1 and ADCINT2 ( )
    AdcRegs.INTSEL1N2.bit.INT1E = 1;
    AdcRegs.INTSEL1N2.bit.INT2E = 1;
    AdcRegs.ADCCTL1.bit.INTPULSEPOS = 1;    //ADCINTs trigger at end of conversion
    // Disable continuous sampling for ADCINT1 and ADCINT2( o day ta can 2 ngat)
    // mode continuous la tao ngat lien tuc sau khi EOC, mat ke ADCINTFLG  = 1; 
    // trong truong hop nay thi ko can nhu vay
...
Uint16 AdcConversion(void)
{
    ...
    // Setup ADCINT1 and ADCINT2 trigger source
    AdcRegs.INTSEL1N2.bit.INT1SEL = 0;      //EOC6 triggers ADCINT1
    AdcRegs.INTSEL1N2.bit.INT2SEL = 1;     //EOC14 triggers ADCINT2
